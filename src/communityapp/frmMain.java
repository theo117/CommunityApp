...
private void mSaveDetails()
 {
    String URL = "jdbc:mysql://localhost:3306/community_db?zeroDateTimeBehavior=CONVERT_TO_NULL";
    String User = "root";
    ...
    try
    {
      ...
      // replace with your own table name and columns etc
       String strInsert = "INSERT INTO people_details(name, address, contact, email, reason_for_visit)"
       + " VALUES("
       + "'" + txtName.getText() + "'" + ", "
       + "'" + txtAddress.getText() + "'" + ", "
       + "'" + txtPhone.getText() + "'" + ", "
   ...
   String User = "root"; 
    ...
    try
    {
       ...
       //update with your own table and column name
        String strInsert = "UPDATE people_details " + "SET name = " + "'" + txtName.getText() + "'"  + ", address = " + "'" + txtAddress.getText() + "'"
