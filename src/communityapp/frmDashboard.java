...
public void mViewForms()
 {
    ...
    try
    {
        ...
        String strSQLQuery = "SELECT * FROM people_details";
...
private void mDeleteBooking() //Deletes data from the database
 {
    ...
    try (Connection con = DriverManager.getConnection(URL, User, Password);
        ...
        String strBookingID = tblForms.getValueAt(tblForms.getSelectedRow(), 0).toString();
        String strQuery = "DELETE FROM people_details WHERE ID = " + strBookingID;

        int confirm = JOptionPane.showConfirmDialog(rootPane, "Are you sure you want to delete this record?", "Confirm Delete", JOptionPane.YES_NO_OPTION);
